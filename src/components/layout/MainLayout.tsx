...
const Star = ({ delay, size, x, y, theme }: { delay: number; size: number; x: number; y: number; theme: string }) => (
    <motion.div
        ...
        style={{
            ...
            left: `${x}%`,
            top: `${y}%`,
            background: `${theme === 'dark' ? 'radial-gradient(circle, rgba(255,255,255,1) 0%, rgba(255,255,255,0.8) 30%, rgba(255,255,255,0) 70%)' : 'radial-gradient(circle, rgba(0,0,0,1) 20%, rgba(0,0,0,0.8) 80%, rgba(0,0,0,0) 80%)'}`,
...
export default function MainLayout() {
    ...
    return (
        <div className="flex min-h-screen w-screen flex-col relative">
            {/* Star background */}
